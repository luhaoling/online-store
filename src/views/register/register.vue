...
export default{
    ...
    methods:{
        isRegister(){
            var that = this;
            this.registerReq.mobile=that.mobile,
            this.registerReq.password=that.password
            register(this.registerReq).then((response)=> {
              cookie.setCookie('name',response.data.data.name,7);
