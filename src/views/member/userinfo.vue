                            ...
                            <div width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                                <div>
                                    <div class="table-box">
                                      ...
                                      <div width="72%" align="left" class="label-input" bgcolor="#FFFFFF"><input name="email" class="input-phone inputBg" type="text" placeholder="" size="25" v-model="userInfo.nickName"></div>
                                    </div>
                                    <div class="table-box">
...
<!--                                    </div>-->
                                    <div class="table-box">
                                        ...
                                        <div width="78%" align="left" class="label-input" bgcolor="#FFFFFF">
                                            <input disabled name="extend_field5" type="text" class="input-phone" v-model="userInfo.mobile">
